...
# Current working directory (PATH equivalent: bg=gray(240), fg=snow2(255))
: ${AGNOSTER_DIR_FG:=255}
: ${AGNOSTER_DIR_BG:=240}

# user (HOST equivalent: bg=night0(236), fg=snow0(253))
: ${AGNOSTER_CONTEXT_FG:=253}
: ${AGNOSTER_CONTEXT_BG:=236}

# Git related (clean: green(150)/night1(237), dirty: red(167)/snow2(255))
: ${AGNOSTER_GIT_CLEAN_FG:=237}
: ${AGNOSTER_GIT_CLEAN_BG:=150}
: ${AGNOSTER_GIT_DIRTY_FG:=255}
: ${AGNOSTER_GIT_DIRTY_BG:=167}

# Bazaar related (follow Git colors)
: ${AGNOSTER_BZR_CLEAN_FG:=237}
: ${AGNOSTER_BZR_CLEAN_BG:=150}
: ${AGNOSTER_BZR_DIRTY_FG:=255}
: ${AGNOSTER_BZR_DIRTY_BG:=167}

# Mercurial related
: ${AGNOSTER_HG_NEWFILE_FG:=255}   # snow2
: ${AGNOSTER_HG_NEWFILE_BG:=167}   # red
: ${AGNOSTER_HG_CHANGED_FG:=255}   # snow2
: ${AGNOSTER_HG_CHANGED_BG:=173}   # orange
: ${AGNOSTER_HG_CLEAN_FG:=237}     # night1
: ${AGNOSTER_HG_CLEAN_BG:=150}     # green

# VirtualEnv colors (VIRTUAL_ENV: bg=green(150), fg=night1(237))
: ${AGNOSTER_VENV_FG:=237}
: ${AGNOSTER_VENV_BG:=150}

# AWS Profile colors (AWS_PROFILE: fg=frost3(68), bg=night0(236))
# production 系だけは bg=red(167), fg=yellow(179) で少し強調
: ${AGNOSTER_AWS_PROD_FG:=179}
: ${AGNOSTER_AWS_PROD_BG:=167}
: ${AGNOSTER_AWS_FG:=68}
: ${AGNOSTER_AWS_BG:=236}
...
#   ROOT: yellow(179)
#   JOB: frost3(68)
#   segment bg=night0(236), fg=snow0(253)
: ${AGNOSTER_STATUS_RETVAL_FG:=167}
: ${AGNOSTER_STATUS_ROOT_FG:=179}
: ${AGNOSTER_STATUS_JOB_FG:=68}
: ${AGNOSTER_STATUS_FG:=253}
: ${AGNOSTER_STATUS_BG:=236}
